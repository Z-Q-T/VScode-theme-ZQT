...
function generateTokenColors(rules) {
	return {
		...
		name: "Specific Code Highlight - ZQT DESIGN Theme",
		"//description": "各个语言专有的代码高亮",
		include: "theme-ZQT-DESIGN_codeUniversal.json",
...
saveObjectToTxtFile(jsonData, "./themes/theme-ZQT-DESIGN_codeSpecific.json");
