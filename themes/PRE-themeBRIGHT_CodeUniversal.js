...
const colorRules = [
	...
	//函数
	{ scopes: "entity.name.function", color: colour.L50_C16_H300 }, //函数名：calcAll()
	{ scopes: "support.function", color: colour.L52_C18_H300 }, //print()
	//变量名
	{ scopes: "variable.language", color: colour.L52_C16_H160 }, //this
	{ scopes: "variable.parameter", color: colour.L52_C15_H140 }, //def cmpt(s, A, t):
	{ scopes: "variable.other.property", color: colour.L50_C15_H100 }, 
	{ scopes: "support.variable.property", color: colour.L52_C15_H100 }, //.length
	{ scopes: "variable", color: colour.L50_C15_H140 }, //combinations、targetvalue //
	{ scopes: "support.variable", color: colour.L52_C17_H140 }, //.length
	//值
	{ scopes: "constant.language", color: colour.L50_C18_H250 }, //true、False、undefined
	{ scopes: "constant.numeric", color: colour.L52_C16_H300 }, //数值：423、1.67
	{ scopes: "string", color: colour.L50_C15_H000 }, //字符串："bienzu"、"32i4hen9"
	{ scopes: "string.regexp", color: colour.L50_C17_H340 }, // /(\w+ab)/
	{ scopes: ["string.interpolated", "string.template"], color: colour.L50_C17_H340 }, //$(pwd)、`date`
	{ scopes: ["constant.character","punctuation.definition.entity"], color: colour.L50_C17_H340 }, //&lt;、&ensp;、\031
	//控制语句
	{ scopes: "keyword.control", color: colour.L50_C18_H000 }, //for、while、else、return
	//运算符
	{ scopes: "keyword.operator", color: colour.L52_C16_H040 }, //运算符：+、-、*、/、||、==
	//类型 
	{ scopes: "storage.type", color: colour.L50_C18_H280 }, //var、let、const、function
	{ scopes: "support.type", color: colour.L52_C17_H280 }, //float()
	{ scopes: "entity.name.type", color: colour.L52_C16_H260 }, //这是啥？不知道
	//标点
	{ scopes: "punctuation.definition", color: colour.L48_C15_H240 }, //""、<>
